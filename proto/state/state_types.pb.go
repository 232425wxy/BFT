...
// It is persisted to disk for each height before calling Reply.
...
func (*ABCIResponses) Descriptor() ([]byte, []int) {
	return fileDescriptor_56528242920b64ce, []int{0}
}
...
func (m *ABCIResponses) GetDeliverTxs() []*abci.ResponseDeliverTx {
	if m != nil {
		return m.DeliverTxs
	}
	return nil
...
func (m *ABCIResponses) GetEndBlock() *abci.ResponseEndBlock {
	if m != nil {
		return m.EndBlock
	}
	return nil
...
func (m *ABCIResponses) GetBeginBlock() *abci.ResponseBeginBlock {
	if m != nil {
		return m.BeginBlock
	}
	return nil
...
func (*ValidatorsInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_56528242920b64ce, []int{1}
}
...
type ConsensusParamsInfo struct {
	ConsensusParams      types2.ConsensusParams `protobuf:"bytes,1,opt,name=consensus_params,json=consensusParams,proto3" json:"consensus_params"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*ConsensusParamsInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_56528242920b64ce, []int{2}
}
...
func (m *ConsensusParamsInfo) GetConsensusParams() types2.ConsensusParams {
	if m != nil {
...
type State struct {
	...
	// LastValidators is used to validate block.LastReply.
...
func (*State) Descriptor() ([]byte, []int) {
	return fileDescriptor_56528242920b64ce, []int{3}
}
...
func init() {
	proto.RegisterType((*ABCIResponses)(nil), "state.ABCIResponses")
	proto.RegisterType((*ValidatorsInfo)(nil), "state.ValidatorsInfo")
	proto.RegisterType((*ConsensusParamsInfo)(nil), "state.ConsensusParamsInfo")
	proto.RegisterType((*State)(nil), "state.State")
}

func init() { proto.RegisterFile("state_types.proto", fileDescriptor_56528242920b64ce) }

var fileDescriptor_56528242920b64ce = []byte{
	// 639 bytes of a gzipped FileDescriptorProto
	,
}
	...
	if m.BeginBlock != nil {
		{
			...
			i -= size
			i = encodeVarintStateTypes(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x1a
	}
...
func (m *ValidatorsInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastHeightChanged != 0 {
		i = encodeVarintStateTypes(dAtA, i, uint64(m.LastHeightChanged))
		i--
		dAtA[i] = 0x10
	}
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.InitialHeight != 0 {
		i = encodeVarintStateTypes(dAtA, i, uint64(m.InitialHeight))
		i--
		dAtA[i] = 0x70
	}
	if len(m.AppHash) > 0 {
		...
		i = encodeVarintStateTypes(dAtA, i, uint64(len(m.AppHash)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.LastResultsHash) > 0 {
		...
		i = encodeVarintStateTypes(dAtA, i, uint64(len(m.LastResultsHash)))
		i--
		dAtA[i] = 0x62
	}
	{
	...
	if m.LastHeightValidatorsChanged != 0 {
		i = encodeVarintStateTypes(dAtA, i, uint64(m.LastHeightValidatorsChanged))
		i--
		dAtA[i] = 0x48
	}
	...
	i -= n9
	i = encodeVarintStateTypes(dAtA, i, uint64(n9))
	i--
	dAtA[i] = 0x2a
	{
	...
	if m.LastBlockHeight != 0 {
		i = encodeVarintStateTypes(dAtA, i, uint64(m.LastBlockHeight))
		i--
		dAtA[i] = 0x18
	}
	if len(m.ChainID) > 0 {
		...
		i = encodeVarintStateTypes(dAtA, i, uint64(len(m.ChainID)))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func encodeVarintStateTypes(dAtA []byte, offset int, v uint64) int {
	offset -= sovStateTypes(v)
	base := offset
	for v >= 1<<7 {
...
func (m *ValidatorsInfo) Size() (n int) {
	...
	if m.LastHeightChanged != 0 {
		n += 1 + sovStateTypes(uint64(m.LastHeightChanged))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *State) Size() (n int) {
	...
	if m.LastBlockHeight != 0 {
		n += 1 + sovStateTypes(uint64(m.LastBlockHeight))
	}
	...
	if m.LastHeightValidatorsChanged != 0 {
		n += 1 + sovStateTypes(uint64(m.LastHeightValidatorsChanged))
	}
	l = m.ConsensusParams.Size()
	n += 1 + l + sovStateTypes(uint64(l))
	...
	if m.InitialHeight != 0 {
		n += 1 + sovStateTypes(uint64(m.InitialHeight))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func sovStateTypes(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozStateTypes(x uint64) (n int) {
	return sovStateTypes(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *ABCIResponses) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowStateTypes
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthStateTypes
			}
		...
		case 2:
			...
			if m.EndBlock == nil {
				m.EndBlock = &abci.ResponseEndBlock{}
			}
		...
		case 3:
			...
			if m.BeginBlock == nil {
				m.BeginBlock = &abci.ResponseBeginBlock{}
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipStateTypes(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipStateTypes(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowStateTypes
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthStateTypes
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupStateTypes
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthStateTypes        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowStateTypes          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupStateTypes = fmt.Errorf("proto: unexpected end of group")
)
