...
func (Errors) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{0}
}
...
func (*PubKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{1}
}
...
func (*PubKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{2}
}
...
func (*SignVoteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{3}
}
...
func (*SignedVoteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{4}
}
...
func (*SignProposalRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{5}
}
...
func (*SignedProposalResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{6}
}
...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{7}
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{8}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_313677ca9caa97b2, []int{9}
}
...
func init() {
	proto.RegisterEnum("prival.Errors", Errors_name, Errors_value)
	proto.RegisterType((*RemoteSignerError)(nil), "prival.RemoteSignerError")
	proto.RegisterType((*PubKeyRequest)(nil), "prival.PubKeyRequest")
	proto.RegisterType((*PubKeyResponse)(nil), "prival.PubKeyResponse")
	proto.RegisterType((*SignVoteRequest)(nil), "prival.SignVoteRequest")
	proto.RegisterType((*SignedVoteResponse)(nil), "prival.SignedVoteResponse")
	proto.RegisterType((*SignProposalRequest)(nil), "prival.SignProposalRequest")
	proto.RegisterType((*SignedProposalResponse)(nil), "prival.SignedProposalResponse")
	proto.RegisterType((*PingRequest)(nil), "prival.PingRequest")
	proto.RegisterType((*PingResponse)(nil), "prival.PingResponse")
	proto.RegisterType((*Message)(nil), "prival.Message")
}

func init() { proto.RegisterFile("prival_types.proto", fileDescriptor_313677ca9caa97b2) }

var fileDescriptor_313677ca9caa97b2 = []byte{
	// 706 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *RemoteSignerError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Description) > 0 {
		...
		i = encodeVarintPrivalTypes(dAtA, i, uint64(len(m.Description)))
		i--
		dAtA[i] = 0x12
	}
	if m.Code != 0 {
		i = encodeVarintPrivalTypes(dAtA, i, uint64(m.Code))
		i--
		dAtA[i] = 0x8
	}
...
func (m *PubKeyRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChainId) > 0 {
		...
		i = encodeVarintPrivalTypes(dAtA, i, uint64(len(m.ChainId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
	...
	if m.Error != nil {
		{
			...
			i -= size
			i = encodeVarintPrivalTypes(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x12
	}
...
func encodeVarintPrivalTypes(dAtA []byte, offset int, v uint64) int {
	offset -= sovPrivalTypes(v)
	base := offset
	for v >= 1<<7 {
...
func (m *RemoteSignerError) Size() (n int) {
	...
	_ = l
	if m.Code != 0 {
		n += 1 + sovPrivalTypes(uint64(m.Code))
	}
	l = len(m.Description)
	if l > 0 {
		n += 1 + l + sovPrivalTypes(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func sovPrivalTypes(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozPrivalTypes(x uint64) (n int) {
	return sovPrivalTypes(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *RemoteSignerError) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowPrivalTypes
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthPrivalTypes
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipPrivalTypes(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipPrivalTypes(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowPrivalTypes
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthPrivalTypes
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupPrivalTypes
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthPrivalTypes        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowPrivalTypes          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupPrivalTypes = fmt.Errorf("proto: unexpected end of group")
)
