...
to a SRBFT node, as well as higher-level functionality.

The commands implementation for production code is client.HTTP, which
connects via http to the jsonrpc interface of the SRBFT node.
...
type ABCIClient interface {
	...
	ABCIQuery(ctx context.Context, data string) (*coretypes.ResultABCIQuery, error)
	ABCIQueryWithOptions(ctx context.Context, data string,
